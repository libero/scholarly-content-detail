...
def test_an_article_can_be_created_by_put_request_without_categories(client):
...
def test_an_articles_can_be_created_by_put_request_with_categories(client, num_of_cats):
...
def test_existing_article_categories_are_replaced_by_put_request_with_categories(client):
